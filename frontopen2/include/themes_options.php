...
<h3>禁用文章图片自动title与alt功能</h3>
<table class="form-table">
<tr>
<th scope="row">禁用</th>
<td width="350">
<input name="fo_image_alt_tag" type="checkbox" id="fo_image_alt_tag" <?php echo get_option('themes_fo_image_alt_tag'); ?> />
</td>
<td>勾选此项后，将不能自动为文章与评论的图片添加alt与title</td>
</tr>
</table>
<br /><br />
...
<th scope="row">禁用</th>
<td width="350">
<input name="fo_disable_autosave" type="checkbox" id="fo_auto_add_tags" <?php echo get_option('themes_fo_disable_autosave'); ?> />
</td>
<td>勾选此项后，将移除自动保存和修订版本</td>
</tr>
</table>
<br /><br />

<h3>禁用自定义Wordpress注册表单页面</h3>
<table class="form-table">
<tr>
<th scope="row">禁用</th>
<td width="350">
<input name="fo_custom-register" type="checkbox" id="fo_custom-register" <?php echo get_option('themes_fo_custom-register'); ?> />
</td>
<td>勾选此项后，将自定义Wordpress注册表单页面,恢复默认表单。</td>
</tr>
</table>
<br /><br />

<h3>禁用自定义Wordpress外链跳转中间页</h3>
<table class="form-table">
<tr>
<th scope="row">禁用</th>
<td width="350">
<input name="fo_go_nf_url" type="checkbox" id="fo_go_nf_url" <?php echo get_option('themes_fo_go_nf_url'); ?> />
</td>
<td>勾选此项后，将禁用自定义Wordpress外链跳转中间页。</td>
</tr>
</table>
<br /><br />
